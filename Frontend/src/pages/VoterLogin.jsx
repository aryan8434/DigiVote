...
export default function VoterLogin() {
    ...
    try {
      ...
      if (res.data?.success) {
        ...
        localStorage.setItem(
          "voterDetails",
          JSON.stringify(res.data.voterDetails || {}),
        );
        navigate(isNative ? "/vote" : "/home");
      } else {
      ...
      setError(
        err.response?.data?.message ||
          "Error occurred while verifying your Voter ID.",
      );
    } finally {
      setLoading(false);
    }
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-50 flex flex-col relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-emerald-500/10 blur-[60px] rounded-full pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-blue-500/10 blur-[60px] rounded-full pointer-events-none" />
      ...
      <main className="flex-1 flex items-center justify-center p-6 z-10">
        <div className="w-full max-w-md">
          <div className="bg-slate-900 border border-slate-800 p-8 rounded-3xl shadow-2xl relative overflow-hidden">
            {/* Inner Glow */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-3/4 h-32 bg-emerald-500/10 blur-2xl rounded-full" />
            ...
            <div className="relative z-10">
              <div className="text-center mb-8">
                ...
                <p className="text-slate-400">
                  Enter your assigned Voter ID to access the DigiVote secure
                  portal.
                </p>
              </div>
